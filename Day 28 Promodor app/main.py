...
def start_timer():
    ...
    if reps%8==0:
        ...
        timer_label.config(text="Long Break!", font=(FONT_NAME,40,"bold"),fg=RED)
    elif reps%2==0:
...
tomato_img = PhotoImage(file="100 Days code/Day 28 Promodor app/tomato.png")
canvas.create_image(100,112, image = tomato_img)
timer_text= canvas.create_text(100,130, text="00:00",fill="white", font=(FONT_NAME,35,"bold"))
canvas.grid(row=1,column=1)


timer_label = Label(window, text="Timer",fg=GREEN,bg= YELLOW,font=(FONT_NAME,40,"bold"))
